                ...
                <div class="col-sm-6">
                    <div class="social-icons pull-right">
                        <ul class="nav navbar-nav">
                            ...
                            <li><a href="{{ getConfigValueFormSettingTable('twiiter_link') }}"><i class="fa fa-twitter"></i></a></li>
                            <li><a href="{{ getConfigValueFormSettingTable('linkedin_link') }}"><i class="fa fa-linkedin"></i></a></li>
                            <li><a href="{{ getConfigValueFormSettingTable('zalo_link') }}"><i class="fa fa-dribbble"></i></a></li>
                            <li><a href="{{ getConfigValueFormSettingTable('gmail_link') }}"><i class="fa fa-google-plus"></i></a></li>
                        </ul>
                    </div>
                </div>
            </div>
